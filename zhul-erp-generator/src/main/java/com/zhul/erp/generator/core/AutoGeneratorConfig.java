package com.zhul.erp.generator.core;
...
public class AutoGeneratorConfig {
  ...
  public PackageConfig createPackageConfigToDao() {
    ...
    packageConfig.setParent("com.zhul.erp.domain.model");
  ...
  public InjectionConfig createInjectionConfigToDao() {
    ...
    focList.add(new FileOutConfig(templatePath4Entity) {
      ...
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/zhul-erp-domain/src/main/java" + "/com/zhul/erp/domain/model/entity/"
    ...
    focList.add(new FileOutConfig(templatePath4Mapper) {
      @Override
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/zhul-erp-domain/src/main/java" + "/com/zhul/erp/domain/model/mapper/"
    ...
    focList.add(new FileOutConfig(templatePath4Repository) {
      @Override
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/zhul-erp-domain/src/main/java" + "/com/zhul/erp/domain/model/repository/"
    ...
    focList.add(new FileOutConfig(templatePath4RepositoryImpl) {
      @Override
      public String outputFile(TableInfo tableInfo) {
        return projectPath + "/zhul-erp-domain/src/main/java"
            + "/com/zhul/erp/domain/model/repository/impl/"
